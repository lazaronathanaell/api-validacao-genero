...
API em FastAPI para validação automatizada de gênero a partir de nomes, utilizando modelos de Machine Learning treinados com dados do IBGE. Gera relatórios em Excel com campos validados e status de correção
